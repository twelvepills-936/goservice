...
WORKDIR ${GOPATH}/src/gitlab16.skiftrade.kz/templates1/go

ENV DIR_PROJECT ${GOPATH}/src/gitlab16.skiftrade.kz/templates1/go
...
COPY --from=build /go/src/gitlab16.skiftrade.kz/templates1/go/api/ /api
COPY --from=build /go/src/gitlab16.skiftrade.kz/templates1/go/scripts/ /scripts
