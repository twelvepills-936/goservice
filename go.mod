...
require (
	...
	github.com/googleapis/googleapis v0.0.0-20250902104618-c850d956dff8 // indirect
	...
	gitlab16.skiftrade.kz/libs-go/requestid v1.0.0 // indirect
	gitlab16.skiftrade.kz/libs-go/telemetry v1.0.0 // indirect
